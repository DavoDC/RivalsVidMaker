...
Generated: 2026-03-31 17:59 | Source: `data/cache/` | 64 total entries
...
## Scan Time Analysis (for time-estimation model)
  ...
  scan_time n=64  min=14.31s  max=65.43s  mean=32.21s  median=29.37s  p10=21.32s  p90=48.52s
  scan/clip ratio n=64  min=0.87x  max=2.67x  mean=1.10x  median=1.00x  p10=0.93x  p90=1.12x

### Linear model: scan_time = 0.838 * clip_duration + 7.173
R-squared: 0.3890

Use this model in the time-estimation UI:
  `predicted_scan_s = 0.838 * clip_duration_s + 7.173`
...
| THOR | 2026-03-05 | QUAD | 9.5s | 23.9s | 25.2s |
